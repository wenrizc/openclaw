...
export const nl: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Meldingen zijn uitgeschakeld voor OpenClaw in macOS. Sta ze toe via Systeeminstellingen > Meldingen.",
    },
    appearance: {
      theme: "Thema",
  ...
  execApproval: {
    ...
    reviewRequest: "Goedkeuring bekijken van {agent}: {command}",
  ...
  subtitles: {
    ...
    security: "Gateway-auth, exec-beleid, toolprofiel en goedkeuringen.",
    advanced: "Alle resterende configuratiesecties, plus de ruwe bestandseditor.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Wat er op dit systeem is veranderd, nieuwste eerst.",
  ...
  mcpPage: {
    connectorsLink: "Ontdek one-click-connectors op de pagina Plugins.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Gefilterd",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Wijzigingen worden direct opgeslagen en gelden voor toekomstige agentruns.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Je Android-telefoon als een volwaardige OpenClaw-node — chat, camera en Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      linux: {
        title: "Linux",
        desc: "Native desktopapp — .deb- en AppImage-builds.",
      },
      chrome: {
  ...
  board: {
    ...
    emptyTitle: "Een leeg board, klaar voor werk",
    ...
    widget: {
      ...
      resizeHandle: "{title} vergroten/verkleinen",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin:
        "Voor het wisselen van vertakking is beheerderstoegang van de operator vereist.",
    ...
    board: {
      ...
      resizeDock: "Chatdock formaat wijzigen",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Houd de microfoonknop van de opsteller ingedrukt, spreek en laat los om tekst in te voegen zonder te verzenden.",
      dictationAudioUnsupported:
        "De Gateway retourneerde een niet-ondersteund dicteeraudioformaat.",
      dictationBrowserAudioUnsupported: "Deze browser kan geen dicteeraudio op 8 kHz opnemen.",
      dictationConnecting: "Dicteren starten…",
      dictationDisconnected: "Dicteren gestopt omdat de Gateway is losgekoppeld.",
