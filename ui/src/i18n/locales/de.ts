...
export const de: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Es wurde keine gespeicherte WhatsApp-Sitzung gelöscht. Möglicherweise ist sie bereits nicht vorhanden, oder ihr Auth-Verzeichnis muss manuell bereinigt werden.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Cloud-Worker erfordern die OpenClaw-Laufzeit; {runtime} ist ausgewählt.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Benachrichtigungen sind für OpenClaw in macOS deaktiviert. Aktivieren Sie sie unter Systemeinstellungen > Mitteilungen.",
    },
    appearance: {
      theme: "Design",
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Zeigen Sie die neueste Assistenten- oder Tool-Aktivität unter laufenden Sitzungen an.",
    },
    connection: {
      title: "Verbindung",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    advanced: "Alle übrigen Konfigurationsbereiche sowie der Roh-Dateieditor.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "Konfigurations-Neuladen gestoppt — frag mich, was passiert ist",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Übersichtliche Chats und schnelle Antworten direkt vom Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      windows: {
        title: "Windows",
        desc: "Der Windows-Begleiter verbindet Ihren PC als OpenClaw-Knoten.",
      },
      linux: {
        title: "Linux",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Wählen Sie ein Bild mit 10 MB oder weniger.",
  ...
  chat: {
    ...
    messages: {
      ...
      rewind: "Zurückspulen",
      rewindConfirm: "Vor diese Nachricht zurückspulen?",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Änderungen werden beim Start Ihrer nächsten Talk-Sitzung übernommen.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Widget-Export fehlgeschlagen. Versuche es erneut.",
