...
export const ja_JP: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "クラウドワーカーにはOpenClawランタイムが必要です。現在は{runtime}が選択されています。",
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count}件のアーカイブされたスレッドとその記録を削除しますか？",
  ...
  custodian: {
    ...
    history: {
      button: "履歴",
      title: "最近の変更",
      description: "このシステムで変更された内容を新しい順に表示。",
      ...
      invalidEdit: "この手動編集は構成検証に合格しませんでした。",
    ...
    nudge: {
      configReload: "構成の再読み込みが停止しました — 何が起きたか尋ねてください",
      channelAuth: "{channel} の認証が低下しました — 何が起きたか尋ねてください",
      channelDisconnected: "{channel} が切断されました — 何が起きたか尋ねてください",
      channelDegraded: "{channel} が低下しています — 何が起きたか尋ねてください",
  ...
  mcpServers: {
    ...
    nameInvalid: "サーバー名には英字、数字、ドット、ダッシュ、アンダースコアを使用できます。",
    targetInvalid: "http(s) の URL またはコマンドラインを入力してください。",
    nameTaken: "「{name}」という名前の MCP サーバーは既に存在します。",
    missing: "MCP サーバー「{name}」は構成内に見つかりませんでした。",
  ...
  mcpPage: {
    connectorsLink: "プラグインページでワンクリックコネクタを見つけましょう。",
    servers: "サーバー",
    oauth: "OAuth",
    filtered: "フィルター済み",
  ...
  labsPage: {
    intro:
      "Labs には実験的な機能が含まれており、リリース間で変更、破損、または削除される可能性があります。",
    sectionTitle: "実験的な機能",
  ...
  appsPage: {
    ...
    heroTagline:
      "スマートフォン、ウォッチ、デスクトップ、ブラウザ向けのコンパニオンアプリと、エージェントの機能を拡張するプラグイン。",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Androidスマホを完全なOpenClawノードに — チャット、カメラ、Canvas。",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "手首からひと目でわかるチャットとクイック返信。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "AndroidコンパニオンがOpenClawをあなたの時計まで拡張します。",
      },
      macos: {
        title: "macOS",
      ...
      plugins: {
        title: "プラグイン & ClawHub",
        desc: "コミュニティのチャンネル、ツール、SkillsでOpenClawを拡張します。",
      },
    },
  },
  profilePage: {
    ...
    identity: {
      title: "アイデンティティ",
      description: "このgateway上のあなたのプロフィール。",
      loading: "あなたのアイデンティティを読み込み中…",
      ...
      avatarErrors: {
        ...
        tooLarge: "処理されたアバターが512 KBを超えています。",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "ダッシュボードウィジェット: {title}。矢印キーで移動します。Alt キーを押しながら矢印キーを押すと移動できます。",
      ...
      remove: "削除",
      needsApproval: "承認が必要",
      needsApprovalDetail: "このウィジェットは追加のアクセスをリクエストしました。",
      allow: "許可",
      reject: "拒否",
      rejected: "アクセスが拒否されました",
      rejectedDetail: "このウィジェットは削除または置換されるまで非アクティブのままです。",
