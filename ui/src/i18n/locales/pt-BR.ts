...
export const pt_BR: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nenhuma sessão armazenada do WhatsApp foi limpa. Ela já pode estar ausente ou seu diretório de autenticação pode precisar de limpeza manual.",
    },
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count} threads arquivadas",
    deleteAllArchived: "Excluir todas as arquivadas…",
    deleteAllArchivedConfirm: "Excluir {count} threads arquivadas e suas transcrições?",
  ...
  subtitles: {
    ...
    custodian: "Configuração e cuidado do sistema.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Configuração e cuidado do sistema.",
  ...
  labsPage: {
    ...
    sectionDescription:
      "As alterações são salvas imediatamente e aplicadas às execuções futuras do agente.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicativos complementares para seu telefone, relógio, desktop e navegador — além de plugins para expandir o que seu agente pode fazer.",
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Aplicativo complementar na barra de menu do seu Gateway — notificações, aprovações e chat rápido.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "App nativo para desktop — versões .deb e AppImage.",
      },
      chrome: {
        title: "Extensão do Chrome",
        desc: "Deixe o OpenClaw controlar seu Chrome — abas, páginas e formulários.",
      },
      plugins: {
  ...
  board: {
    ...
    tabsLabel: "Abas do dashboard",
    moreTabs: "Mais abas do dashboard",
    gridLabel: "Widgets do dashboard",
    ...
    actionFailed: "Não foi possível salvar a alteração do dashboard.",
    actionInProgress: "Outra alteração do dashboard ainda está sendo salva.",
    announcement: {
      moved: "{title} movido.",
    ...
    widget: {
      cellLabel:
        "Widget do dashboard: {title}. Use as teclas de seta para navegar. Segure Alt e pressione uma tecla de seta para movê-lo.",
  ...
  chat: {
    ...
    board: {
      ...
      mockSessionStatus: "Status do thread",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Segure o botão do microfone do compositor, fale e solte para inserir texto sem enviar.",
