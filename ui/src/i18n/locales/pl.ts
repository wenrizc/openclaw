...
export const pl: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      avatarTooLarge: "Przetworzony awatar jest wciąż zbyt duży.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Pokaż aktywność agenta na żywo w pasku bocznym",
      liveActivityHint:
  ...
  custodian: {
    ...
    connectionChanged: "Połączenie z Gateway zmieniło się. Ponów, aby kontynuować konfigurację.",
  ...
  labsPage: {
    intro:
      "Labs zawiera eksperymentalne funkcje, które mogą się zmienić, przestać działać lub zniknąć między wydaniami.",
    ...
    codeMode: {
      title: "Tryb kodu",
      description:
        "Pozwól agentom łączyć narzędzia w zwarte, izolowane przepływy pracy w JavaScript.",
    },
    swarm: {
      title: "Swarm",
      description: "Pozwól trybowi kodu zarządzać grupami subagentów równolegle.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Twój telefon z systemem Android jako pełnoprawny węzeł OpenClaw — czat, aparat i Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Podglądowe czaty i szybkie odpowiedzi prosto z nadgarstka.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      chrome: {
        ...
        desc: "Pozwól OpenClaw obsługiwać Twój istniejący Chrome — karty, strony i formularze.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      profileUnavailable: "Nie udało się załadować profilu Twojej tożsamości.",
      avatar: "Awatar",
  ...
  board: {
    ...
    emptyTitle: "Czysty pulpit, gotowy do pracy",
    emptyHint: "Twój agent może przypiąć tutaj widżety — spróbuj poprosić o kartę stanu.",
  ...
  chat: {
    ...
    board: {
      ...
      resetDescription: "Kontekst rozmowy zostanie zresetowany. Panel pozostanie bez zmian.",
    },
    catalog: {
