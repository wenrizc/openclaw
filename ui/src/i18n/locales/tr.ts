...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı hiçbir WhatsApp oturumu temizlenmedi. Zaten yok olabilir ya da yetkilendirme dizini elle temizlenmesi gerekebilir.",
    },
  ...
  sessionsView: {
    ...
    attentionRequired: "Oturum dikkat gerektiriyor",
    model: "Model",
    provider: "Sağlayıcı",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "OpenClaw için bildirimler macOS'ta devre dışı. Sistem Ayarları > Bildirimler'den bunlara izin verin.",
    },
    appearance: {
      theme: "Tema",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Canlı ajan etkinliğini kenar çubuğunda göster",
      liveActivityHint:
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Bu sistemde değişen şeyler, en yeniden başlayarak.",
      ...
      invalidEdit: "Bu manuel düzenleme yapılandırma doğrulamasından geçmedi.",
      opaqueChange:
    ...
    nudge: {
      configReload: "Yapılandırma yeniden yükleme durdu — bana ne olduğunu sorun",
      ...
      channelDegraded: "{channel} bozuk durumda — bana ne olduğunu sorun",
  ...
  mcpPage: {
    connectorsLink: "Eklentiler sayfasında tek tıklamayla bağlanabilen konnektörleri keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Ajanların araçları kompakt, korumalı JavaScript iş akışlarında birleştirmesine izin verin.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode'un alt ajan gruplarını paralel olarak yönetmesine izin verin.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Telefonunuz, saatiniz, masaüstünüz ve tarayıcınız için yardımcı uygulamalar — ayrıca ajanınızın yapabileceklerini genişleten eklentiler.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS'ten OpenClaw ile sohbet edin, konuşun, eylemleri onaylayın ve paylaşın.",
      },
      android: {
        title: "Android",
  ...
  board: {
    ...
    emptyHint: "Aracınız buraya widget sabitleyebilir — bir durum kartı istemeyi deneyin.",
    ...
    widget: {
      ...
      rejectedDetail: "Bu widget kaldırılana veya değiştirilene kadar pasif kalır.",
  ...
  chat: {
    ...
    messages: {
      ...
      hide: "Gizle",
      hideConfirm: "Bu mesaj bu tarayıcıda gizlensin mi? Aracı hâlâ görür.",
      ...
      rewindUnavailable: "Aracı çalışırken geri alma kullanılamaz",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Yazma alanı mikrofon düğmesini basılı tutun, konuşun, ardından metni göndermeden eklemek için bırakın.",
      ...
      dictationFinalizationTimedOut: "Son kısmi metin sonlandırılamadan dikte durduruldu.",
      dictationProviderUnavailable: "Dikte için yapılandırılmış bir yazıya dökme sağlayıcısı yok.",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Bu widget'ın görüntü olarak dışa aktarılması için yeniden işlenmesi gerekiyor.",
