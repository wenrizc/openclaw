...
export const ko: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "로그아웃되었습니다.",
      logoutNotCleared:
        "삭제된 저장 WhatsApp 세션이 없습니다. 이미 없거나 인증 디렉터리를 수동으로 정리해야 할 수 있습니다.",
    },
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "이 Mac의 OpenClaw 앱에서 알림이 기본으로 표시됩니다.",
  ...
  subtitles: {
    ...
    notifications: "게이트웨이에서 보내는 브라우저 푸시 알림.",
    security: "Gateway 인증, exec 정책, 도구 프로필, 승인.",
    advanced: "남은 모든 설정 섹션과 원본 파일 편집기.",
    debug: "스냅샷, 이벤트, RPC.",
    logs: "실시간 Gateway 로그.",
  ...
  custodian: {
    ...
    sensitiveReply: "민감한 답장을 보냈습니다",
    send: "보내기",
    thinking: "OpenClaw가 생각하는 중",
    earlier: "이전",
    ...
    history: {
      ...
      requestFailed: "OpenClaw가 변경 기록을 불러올 수 없습니다.",
      loadMore: "더 보기",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description: "에이전트가 도구를 간결한 샌드박스 JavaScript 워크플로에 결합하도록 합니다.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode가 서브에이전트 그룹을 병렬로 조율하도록 합니다.",
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 워치, 데스크톱, 브라우저용 컴패니언 앱과 에이전트의 기능을 확장하는 플러그인을 제공합니다.",
    sectionMobile: "휴대폰에서",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Android 폰을 완전한 OpenClaw 노드로 — 채팅, 카메라, Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      chrome: {
        ...
        desc: "OpenClaw가 기존 Chrome을 제어하도록 하세요 — 탭, 페이지, 폼.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "아바타",
      avatarDescription: "PNG, JPEG 또는 WebP. 이미지는 256 × 256 이하로 조정됩니다.",
      chooseAvatar: "이미지 선택",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "복사됨",
      branches: "스레드 브랜치",
      branchSwitchUnavailable: "에이전트가 작업 중일 때는 브랜치 전환을 사용할 수 없습니다.",
      branchSwitchRequiresAdmin: "브랜치 전환에는 운영자 관리자 액세스 권한이 필요합니다.",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "작성기의 마이크 버튼을 누른 채 말한 다음, 손을 떼면 전송하지 않고 텍스트가 삽입됩니다.",
