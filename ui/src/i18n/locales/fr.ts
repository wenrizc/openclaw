...
export const fr: TranslationMap = {
  ...
  sessionsView: {
    ...
    attentionRequired: "La session nécessite une attention",
    model: "Modèle",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "Rechargement de la configuration arrêté — demandez-moi ce qui s'est passé",
  ...
  labsPage: {
    intro:
      "Labs contient des fonctionnalités expérimentales qui peuvent changer, cesser de fonctionner ou disparaître d'une version à l'autre.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Applications compagnons pour votre téléphone, votre montre, votre bureau et votre navigateur — ainsi que des plugins pour étendre les capacités de votre agent.",
    ...
    cards: {
      ...
      linux: {
        title: "Linux",
        desc: "Application de bureau native — builds .deb et AppImage.",
      },
      chrome: {
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable:
        "Le changement de branche n'est pas disponible pendant que l'agent travaille.",
    ...
    questions: {
      ...
      submitting: "Envoi…",
      submitFailed: "Échec de l'envoi : {error}",
      answered: "Réponse reçue",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Maintenez le bouton du microphone de la zone de saisie, parlez, puis relâchez pour insérer le texte sans l'envoyer.",
