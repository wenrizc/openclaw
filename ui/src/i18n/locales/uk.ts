...
export const uk: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Збережена сесія WhatsApp не була очищена. Можливо, її вже немає, або її каталог автентифікації потребує ручного очищення.",
    },
  ...
  configView: {
    categories: {
      ...
      security: "Приватність і безпека",
      automation: "Автоматизація",
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Сповіщення вимкнено для OpenClaw у macOS. Дозвольте їх у Системні налаштування > Сповіщення.",
    },
    appearance: {
      theme: "Тема",
  ...
  subtitles: {
    ...
    labs: "Експериментальні можливості агентів і інструментів.",
  ...
  mcpServers: {
    ...
    nameInvalid: "Назви серверів містять літери, цифри, крапки, дефіси або підкреслення.",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Дозвольте Code Mode оркеструвати групи субагентів паралельно.",
      empty: "Немає активних р- Swarm.",
    },
  },
  aboutPage: {
  ...
  appsPage: {
    ...
    pairDevice: "Спарувати ваш пристрій",
    ...
    ctaOpenPlugins: "Відкрити Plugins",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкий перегляд чатів і миттєві відповіді просто з зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Віджет панелі: {title}. Використовуйте клавіші зі стрілками для навігації. Утримуйте Alt і натисніть стрілку, щоб перемістити його.",
  ...
  chat: {
    ...
    messages: {
      ...
      hide: "Приховати",
      hideConfirm: "Приховати це повідомлення в цьому браузері? Агент все одно його бачить.",
    ...
    composer: {
      ...
      dictationAudioUnsupported: "Gateway повернув непідтримуваний формат аудіо диктування.",
      ...
      dictationDisconnected: "Диктування зупинено, оскільки Gateway від’єднався.",
      dictationFailed: "Помилка диктування.",
      dictationFinalizing: "Завершення диктування…",
      dictationFinalizationTimedOut:
        "Диктування зупинено до того, як останній фрагмент транскрипції було остаточно оброблено.",
      ...
      selectedCameraUnavailable:
        "Обрана камера недоступна. Виберіть іншу камеру або Системну за замовчуванням.",
