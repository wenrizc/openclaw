...
export const id: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime: "Cloud worker memerlukan runtime OpenClaw; {runtime} dipilih.",
  ...
  subtitles: {
    ...
    advanced: "Setiap bagian konfigurasi yang tersisa, plus editor file mentah.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "Muat ulang konfigurasi terhenti — tanyakan kepada saya apa yang terjadi",
  ...
  labsPage: {
    ...
    sectionDescription: "Perubahan disimpan segera dan berlaku untuk proses agent berikutnya.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Biarkan agent menggabungkan tools dalam alur kerja JavaScript yang ringkas dan tersandboxi.",
    },
    swarm: {
      title: "Swarm",
      description: "Biarkan Code Mode mengatur kelompok subagent secara paralel.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplikasi pendamping untuk ponsel, jam tangan, desktop, dan browser Anda — plus plugin untuk memperluas kemampuan agent Anda.",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget dasbor: {title}. Gunakan tombol panah untuk navigasi. Tahan Alt dan tekan tombol panah untuk memindahkannya.",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Dokkan obrolan ke kiri",
      dockRight: "Dokkan obrolan ke kanan",
      dockBottom: "Dokkan obrolan ke bawah",
      ...
      resetDescription: "Konteks percakapan disetel ulang. Dasbor Anda tetap.",
    },
    catalog: {
