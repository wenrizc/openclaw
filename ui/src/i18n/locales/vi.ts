...
export const vi: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Không có phiên WhatsApp nào được lưu bị xóa. Có thể phiên đó đã không còn, hoặc thư mục xác thực của nó cần được dọn dẹp thủ công.",
    },
  ...
  sessionsView: {
    ...
    dashboardAvailable: "Bảng điều khiển có sẵn",
    approvalNeeded: "Cần phê duyệt",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG, hoặc WebP. Hình ảnh được cắt giữa và thay đổi kích thước về 512px.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Thông báo được hiển thị theo cách gốc bởi ứng dụng OpenClaw trên máy Mac này.",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange:
        "Định dạng hoặc chú thích đã thay đổi mà không có thay đổi đường dẫn cấu hình nào hiển thị.",
      sources: {
    ...
    nudge: {
      configReload: "Tải lại cấu hình đã dừng — hỏi tôi chuyện gì đã xảy ra",
      channelAuth: "Xác thực {channel} bị suy giảm — hỏi tôi chuyện gì đã xảy ra",
      channelDisconnected: "{channel} vừa ngắt kết nối — hỏi tôi chuyện gì đã xảy ra",
  ...
  mcpServers: {
    ...
    nameInvalid: "Tên máy chủ dùng chữ cái, số, dấu chấm, dấu gạch ngang hoặc gạch dưới.",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Cho phép Code Mode điều phối các nhóm tác nhân con song song.",
  ...
  appsPage: {
    ...
    badgeBundledIos: "Bao gồm trong ứng dụng iOS",
    badgeBundledAndroid: "Bao gồm trong ứng dụng Android",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Trò chuyện liếc nhìn và trả lời nhanh ngay trên cổ tay.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Ảnh đại diện",
      avatarDescription:
        "PNG, JPEG hoặc WebP. Hình ảnh được điều chỉnh kích thước xuống 256 × 256 hoặc nhỏ hơn.",
  ...
  board: {
    ...
    emptyHint: "Tác nhân của bạn có thể ghim tiện ích tại đây — thử yêu cầu một thẻ trạng thái.",
    ...
    announcement: {
      ...
      rejected: "Đã từ chối truy cập tiện ích.",
    },
    widget: {
      cellLabel:
        "Tiện ích bảng điều khiển: {title}. Dùng phím mũi tên để điều hướng. Giữ Alt và nhấn phím mũi tên để di chuyển.",
      moveHandle: "Di chuyển {title}",
      resizeHandle: "Đổi kích thước {title}",
      menuLabel: "Tùy chọn tiện ích",
      moveToTab: "Chuyển sang tab",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Không thể chuyển nhánh khi tác nhân đang hoạt động.",
    ...
    board: {
      ...
      resizeDock: "Thay đổi kích thước neo trò chuyện",
      reopenChat: "Hiện trò chuyện",
      mockPlaceholder: "Vùng xem bảng · {tabs} tab · {widgets} widget",
      ...
      resetDescription:
        "Bối cảnh cuộc trò chuyện được đặt lại. Bảng điều khiển của bạn vẫn giữ nguyên.",
    },
    catalog: {
    ...
    messages: {
      ...
      hide: "Ẩn",
      hideConfirm: "Ẩn tin nhắn này trong trình duyệt này? Tác nhân vẫn thấy được nó.",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Các thay đổi được áp dụng khi bạn bắt đầu phiên Talk tiếp theo.",
      microphoneListUnsupported: "Trình duyệt này không thể liệt kê đầu vào micrô.",
      noCameras: "Không tìm thấy camera nào khác",
      ...
      holdToRecordSetting: "Giữ nút micro để đọc chính tả",
      holdToRecordSettingDescription:
        "Giữ nút micro trong trình soạn thảo, nói, rồi thả ra để chèn văn bản mà không gửi.",
      ...
      dictationBrowserAudioUnsupported:
        "Trình duyệt này không thể thu âm thanh đọc chính tả ở mức 8 kHz.",
      ...
      dictationFinalizationTimedOut:
        "Đọc chính tả đã dừng trước khi bản chép một phần cuối cùng có thể được hoàn tất.",
      dictationProviderUnavailable: "Chưa cấu hình nhà cung cấp chép lời nào cho đọc chính tả.",
      dictationRecording: "Đang ghi {elapsed}",
      dictationReleaseToInsert: "Thả để chèn phần đọc chính tả",
      ...
      selectedCameraUnavailable:
        "Máy ảnh đã chọn không khả dụng. Hãy chọn máy ảnh khác hoặc dùng System default.",
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySeconds: "Chạy sau mỗi {amount} giây",
