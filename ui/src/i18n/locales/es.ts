...
export const es: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "No se borró ninguna sesión de WhatsApp almacenada. Es posible que ya no exista o que su directorio de autenticación requiera limpieza manual.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Los trabajadores en la nube requieren el runtime de OpenClaw; {runtime} está seleccionado.",
  ...
  sessionsView: {
    ...
    lastActive: "Activa por última vez {time}",
    surface: "Superficie",
    subject: "Asunto",
    room: "Sala",
    space: "Espacio",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Muestra la actividad más reciente del asistente o de la herramienta debajo de las sesiones en ejecución.",
    },
    connection: {
      title: "Conexión",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    advanced:
      "Todas las secciones de configuración restantes, más el editor de archivos sin procesar.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Qué cambió en este sistema, del más reciente al más antiguo.",
  ...
  labsPage: {
    ...
    codeMode: {
      ...
      description:
        "Permite a los agentes combinar herramientas en flujos de trabajo de JavaScript compactos y aislados.",
    },
    swarm: {
      title: "Swarm",
      description: "Permite que el Modo de código orqueste grupos de subagentes en paralelo.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Aplicación complementaria en la barra de menús para tu Gateway: notificaciones, aprobaciones y chat rápido.",
      },
      windows: {
        title: "Windows",
      ...
      chrome: {
        ...
        desc: "Permite que OpenClaw controle tu Chrome existente: pestañas, páginas y formularios.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      openSettings: "Abrir configuración de identidad de {name}",
      avatarErrors: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget de panel: {title}. Usa las teclas de flecha para navegar. Mantén pulsada Alt y pulsa una tecla de flecha para moverlo.",
  ...
  chat: {
    ...
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "¿Ocultar este mensaje en este navegador? El agente todavía lo ve.",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Mantén pulsado el botón de micrófono del compositor, habla y suelta para insertar texto sin enviarlo.",
