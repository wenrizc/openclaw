...
export const fa: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      noApp: "هنوز اپلیکیشن را ندارید؟",
      getApps: "دریافت اپلیکیشن‌ها",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "کارگزاران ابری به زمان اجرای OpenClaw نیاز دارند؛ {runtime} انتخاب شده است.",
  ...
  sessionsView: {
    ...
    attentionRequired: "این نشست به توجه نیاز دارد",
    model: "مدل",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileLoadFailed: "بارگیری نمایه شما ممکن نشد.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint: "آخرین فعالیت دستیار یا ابزار را زیر نشست‌های در حال اجرا نمایش بده.",
    },
    connection: {
      title: "اتصال",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    subtitleCaretaker: "راه‌اندازی و مراقبت از سیستم.",
    ...
    history: {
      button: "تاریخچه",
      title: "تغییرات اخیر",
      description: "آنچه در این سیستم تغییر کرد، جدیدترین‌ها ابتدا.",
      ...
      invalidEdit: "این ویرایش دستی اعتبارسنجی پیکربندی را پشت سر نگذاشت.",
      opaqueChange: "قالب‌بندی یا نظرها بدون تغییر قابل‌مشاهده در مسیر پیکربندی تغییر کردند.",
      sources: {
    ...
    nudge: {
      ...
      channelAuth: "احراز هویت {channel} افت کرد — از من بپرسید چه اتفاقی افتاد",
      channelDisconnected: "{channel} همین حالا قطع شد — از من بپرسید چه اتفاقی افتاد",
      channelDegraded: "{channel} دچار افت شده است — از من بپرسید چه اتفاقی افتاد",
  ...
  mcpServers: {
    ...
    nameInvalid: "نام‌های سرور از حروف، اعداد، نقطه، خط تیره یا زیرخط استفاده می‌کنند.",
  ...
  labsPage: {
    intro:
      "Labs شامل قابلیت‌های آزمایشی است که ممکن است بین نسخه‌ها تغییر کند، خراب شود یا ناپدید شود.",
    sectionTitle: "ویژگی‌های آزمایشی",
    sectionDescription: "تغییرات بلافاصله ذخیره می‌شوند و روی اجراهای آینده عامل اعمال می‌شوند.",
  ...
  appsPage: {
    ...
    heroTagline:
      "برنامه‌های همراه برای گوشی، ساعت، دسکتاپ و مرورگر شما — به‌همراه افزونه‌هایی برای گسترش توانایی‌های عامل شما.",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "گوشی اندرویدی شما به عنوان یک نود کامل OpenClaw — چت، دوربین و Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "چت‌های قابل مشاهده در یک نگاه و پاسخ‌های سریع از مچ دست شما.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "نام نمایشی",
      displayNameDescription: "به دیگر افرادی که از این gateway استفاده می‌کنند نمایش داده می‌شود.",
  ...
  board: {
    ...
    widget: {
      ...
      rejectedDetail: "این ویجت تا زمان حذف یا جایگزینی غیرفعال می‌ماند.",
      frameResolverMissing: "محتوای ویجت در دسترس نیست.",
      errorTitle: "این ویجت بارگذاری نشد",
      errorDetail: "مشکل تنها به همین کارت محدود است.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "کپی شد",
      branches: "شاخه‌های گفت‌وگو",
      branchSwitchUnavailable: "زمانی که عامل در حال کار است، تغییر شاخه در دسترس نیست.",
      branchSwitchRequiresAdmin: "تغییر شاخه به دسترسی ادمین اپراتور نیاز دارد.",
    ...
    board: {
      faceLabel: "نمای گفت‌وگو",
      chatFace: "گفت‌وگو",
      dashboardFace: "داشبورد",
      dockMenu: "پنل چت: {dock}",
      dockLeft: "پنل چت در چپ",
      dockRight: "پنل چت در راست",
      dockBottom: "پنل چت در پایین",
      dockHidden: "پنهان کردن چت",
      resizeDock: "تغییر اندازه پنل چت",
      reopenChat: "نمایش چت",
      mockPlaceholder: "درز نمای برد · {tabs} برگه · {widgets} ویجت",
      ...
      resetDescription: "بافت گفتگو بازنشانی می‌شود. داشبورد شما باقی می‌ماند.",
    },
    catalog: {
    ...
    composer: {
      ...
      dictationDisconnected: "دیکته به دلیل قطع اتصال Gateway متوقف شد.",
    ...
    sessionDiscussion: {
      ...
      open: "باز کردن بحث",
      opening: "در حال باز کردن بحث…",
      opened: "بحث نشست",
      openExternal: "باز کردن بحث در برگه جدید",
      frameTitle: "بحث نشست",
      unavailable: "این بحث قابل جاسازی نیست.",
    },
    workspaceFiles: {
